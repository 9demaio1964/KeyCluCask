...
A simple and handy overview of application shortcuts. Easy to use: just press `⌘` twice and hold to see the list.
...
## Permissions
* Requires access to `Accessibility API` to operate.
* `Notification Center` access is recommended for gentle update notifications.
...
* Display macOS gestures
* Display skhd hotkeys
* Display Jitouch2 gestures
